#-----------------------------------------------------------------
#
#   File name   : Assigment32Question3.py
#   Descreption : Design automation script which accept directory name and delete all duplicate files from 
#                 that directory. Write names of duplicate files from that directory into log file named 
